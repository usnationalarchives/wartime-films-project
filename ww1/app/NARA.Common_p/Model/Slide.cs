...
{
    /// <summary>
    /// Mapping class for retrieving Slide entity from
    /// museu.ms platform API
    /// </summary>
    public class Slide
    {
        public object VexSlideTranslations { get; set; }
        public List<Object> Objects { get; set; }
        public Template Template { get; set; }
        public int VexTemplateId { get; set; }
        public int VexThemeId { get; set; }
        ...
        public List<object> DocumentAudios { get; set; }
    }
}
