...
namespace NARA
{
    ...
    public partial class Registration : ContentPage
    {
        ...
        Button btn_SignUp;
        RoundedImage circleImage = new RoundedImage() { Margin = new Thickness(10, 0, 0, 0), HeightRequest = 80, WidthRequest = 80, Aspect = Aspect.AspectFill, Source = "BorderImage.png", HorizontalOptions = LayoutOptions.Start };
        Frame frame;
        ...
        //Color.FromHex("#E0665E")
        BoxView usernameBorder = new BoxView() { HorizontalOptions = LayoutOptions.FillAndExpand, HeightRequest = 1, Color = Color.White };
        BoxView emailBorder = new BoxView() { HorizontalOptions = LayoutOptions.FillAndExpand, HeightRequest = 1, Color = Color.White };
        BoxView passwordBorder = new BoxView() { HorizontalOptions = LayoutOptions.FillAndExpand, HeightRequest = 1, Color = Color.White };
        BoxView confirmPasswordBorder = new BoxView() { HorizontalOptions = LayoutOptions.FillAndExpand, HeightRequest = 1, Color = Color.White };
        ...
        public Registration(string returnUrl = "")
        {
            try
            {
                ...
                btn_Cancel = new LabelCustom() { HeightRequest = lblHeight, WidthRequest = 75, BorderWidth = 3, BorderRadius = 8, BorderColor = Color.FromHex("#E0665E"), LetterSpacing = 1, Text = "SIGN UP", TextColor = Color.White, HorizontalTextAlignment = TextAlignment.Center, VerticalTextAlignment = TextAlignment.Center, VerticalOptions = LayoutOptions.CenterAndExpand, HorizontalOptions = LayoutOptions.EndAndExpand };
                ...
                if (Device.OS == TargetPlatform.Android)
                {
                    ...
                    stack_ForAndroid.HeightRequest = 780;
                }
                ...
                entry_Username = new EntryCustom() { Placeholder = "Username                    ", TextColor = Color.FromHex("#FFFFFF"), FontSize = 14, PlaceholderColor = Color.FromHex("#FFFFFF"), BackgroundColor = Color.Transparent, HeightRequest = 30, HorizontalOptions = LayoutOptions.Center, FontFamily = Device.OnPlatform("Freight", "freightsans.otf#Freight", "") };
                entry_Email = new EntryCustom() { Placeholder = "Email                     ", TextColor = Color.FromHex("#FFFFFF"), FontSize = 14, PlaceholderColor = Color.FromHex("#FFFFFF"), BackgroundColor = Color.Transparent, HeightRequest = 30, HorizontalOptions = LayoutOptions.Center, FontFamily = Device.OnPlatform("Freight", "freightsans.otf#Freight", "") };

                entry_Password = new EntryCustom() { Placeholder = "Create a password", TextColor = Color.FromHex("#FFFFFF"), IsPassword = true, FontSize = 14, PlaceholderColor = Color.FromHex("#FFFFFF"), VerticalOptions = LayoutOptions.Center, BackgroundColor = Color.Transparent, HeightRequest = 30, HorizontalOptions = LayoutOptions.Center, FontFamily = Device.OnPlatform("Freight", "freightsans.otf#Freight", "") };
                entry_PasswordRepeat = new EntryCustom() { Placeholder = "Confirm password", TextColor = Color.FromHex("#FFFFFF"), IsPassword = true, FontSize = 14, PlaceholderColor = Color.FromHex("#FFFFFF"), VerticalOptions = LayoutOptions.Center, BackgroundColor = Color.Transparent, HeightRequest = 30, HorizontalOptions = LayoutOptions.Center, FontFamily = Device.OnPlatform("Freight", "freightsans.otf#Freight", "") };

                btn_SignUp = new Button() { Margin = new Thickness(0,0,0,0), Text = "CREATE YOUR PROFILE", WidthRequest = 200, BorderColor = Color.FromHex("#E0665E"), FontSize = 16, BorderRadius = 20, BorderWidth = 2, BackgroundColor = Color.FromHex("#E0665E"), TextColor = Color.White, VerticalOptions = LayoutOptions.Start, HorizontalOptions = LayoutOptions.Center };

                btn_SignUp.Clicked += btn_SignUp_Clicked;

                btnHolder = new StackLayout() { Spacing = 14, Padding = new Thickness(10, 0, 10, 0), HorizontalOptions = LayoutOptions.EndAndExpand };
                btnHolder.Children.Add(new Label() { TextColor = Color.White, Text = "... OR SIGN UP WITH AN EMAIL", FontSize = 16, FontFamily = Device.OnPlatform("Freight", "freightsans.otf#Freight", "") });


                btnHolder.Children.Add(new StackLayout() { VerticalOptions = LayoutOptions.End, HorizontalOptions = LayoutOptions.CenterAndExpand, Orientation = StackOrientation.Vertical, Spacing = 20, Children = { entry_Username } });
                btnHolder.Children.Add(new StackLayout() { VerticalOptions = LayoutOptions.Start, HorizontalOptions = LayoutOptions.CenterAndExpand, Orientation = StackOrientation.Vertical, Spacing = 20, Children = { usernameBorder } });
                btnHolder.Children.Add(new StackLayout() { VerticalOptions = LayoutOptions.End, HorizontalOptions = LayoutOptions.CenterAndExpand, Orientation = StackOrientation.Vertical, Spacing = 20, Children = { entry_Email } });
                btnHolder.Children.Add(new StackLayout() { VerticalOptions = LayoutOptions.Start, HorizontalOptions = LayoutOptions.CenterAndExpand, Orientation = StackOrientation.Vertical, Spacing = 20, Children = { emailBorder } });

                btnHolder.Children.Add(new StackLayout() { HorizontalOptions = LayoutOptions.CenterAndExpand, Orientation = StackOrientation.Horizontal, Spacing = 20, Children = { entry_Password, entry_PasswordRepeat } });
                btnHolder.Children.Add(new StackLayout() { VerticalOptions = LayoutOptions.Start, HorizontalOptions = LayoutOptions.CenterAndExpand, Orientation = StackOrientation.Horizontal, Spacing = 20, Children = { passwordBorder, confirmPasswordBorder } });

                //btnHolder.Children.Add(entry_PasswordRepeat);

                Button imagePicker = new Button() { Text = "Add profile photo", TextColor = Color.FromHex("#FFFFFF"), FontSize = 12, FontFamily = Device.OnPlatform("Freight", "freightsans.otf#Freight", "") };

                frame = new Frame() { OutlineColor = Device.OnPlatform(Color.FromHex("#FFFFFF"), Color.White, Color.White), BackgroundColor = Color.FromHex("#1d1d1d"), HeightRequest = 80, WidthRequest = 80 };
                StackLayout stack = new StackLayout() { Orientation = StackOrientation.Vertical, HeightRequest = 120 };
                stack.Children.Add(circleImage);
                stack.Children.Add(new Label() { Margin = new Thickness(0,10,0,0), Text = "Add profile photo", FontFamily = Device.OnPlatform("Freight", "freightsans.otf#Freight", ""), TextColor = Color.FromHex("#FFFFFF"), HorizontalOptions = LayoutOptions.Start, VerticalOptions = LayoutOptions.Start, FontSize = 14 });
                frame.Content = stack;
                ...
                stack.GestureRecognizers.Add(tapGestureAvatar);
                ...
                lbl_Teachers = new Label() { Text = "I'm a teacher", HorizontalTextAlignment = TextAlignment.Start, VerticalTextAlignment = TextAlignment.Center, FontSize = 14, TextColor = Color.FromHex("#FFFFFF"), FontFamily = Device.OnPlatform("Freight", "freightsans.otf#Freight", "") };
                ...
                formatedString.Spans.Add(new Span() { FontSize = 14, Text = "I agree to NARA's ", FontFamily = Device.OnPlatform("Freight", "freightsans.otf#Freight", "") });
                formatedString.Spans.Add(new Span() { FontSize = 14, Text = "privacy and use policies", FontFamily = Device.OnPlatform("Freight", "freightsans.otf#Freight", ""), ForegroundColor = Color.FromHex("#559FE3") });

                lbl_Terms = new Label() { FormattedText = formatedString, VerticalTextAlignment = TextAlignment.Center, HorizontalTextAlignment = TextAlignment.Start, FontSize = 14, TextColor = Color.FromHex("#FFFFFF") };
                ...
                lbl_Newsletter = new Label() { FontFamily = Device.OnPlatform("Freight", "freightsans.otf#Freight", ""), Text = "Would you like to receive emails regarding this app?", VerticalTextAlignment = TextAlignment.Center, HorizontalTextAlignment = TextAlignment.Start, FontSize = 14, TextColor = Color.FromHex("#FFFFFF") };
                ...
                Grid grid_EmailRegistration = new Grid()
                {
                    ColumnDefinitions =
                    {
                ...
                var stackImagePicker = new StackLayout() { Children = { stack }, HeightRequest = 120 };

                //stackImagePicker.GestureRecognizers.Add(tapGestureAvatar);
                grid_EmailRegistration.Children.Add(btnHolder, 0, 0);
                grid_EmailRegistration.Children.Add(stackImagePicker, 1, 0);
                grid_EmailRegistration.Children.Add(cv_Btn, 0, 1);
                Grid.SetColumnSpan(cv_Btn, 2);

                //

                stack_Forms.Children.Add(grid_EmailRegistration);
                ...
                titleDescription = new LabelCustom() { FontSize = 16, Text = "Sign up to create and share your own collections using existing app content, and gather favorites on your profile page.", TextColor = Color.White, HorizontalTextAlignment = TextAlignment.Center, VerticalTextAlignment = TextAlignment.Center, FontFamily = Device.OnPlatform("Freight", "freightsans.otf#Freight", ""), HorizontalOptions = LayoutOptions.FillAndExpand, VerticalOptions = LayoutOptions.FillAndExpand, LineSpacing = 5 };

                cv_Title.Children.Add(titleDescription,1,1);
                ...
                entry_Password.Focused += Entry_Password_Focused;
                entry_PasswordRepeat.Focused += Entry_PasswordRepeat_Focused;
                entry_Username.Focused += Entry_Username_Focused;

                entry_Email.Unfocused += Entry_Email_Unfocused;
                entry_Password.Unfocused += Entry_Email_Unfocused;
                entry_PasswordRepeat.Unfocused += Entry_Email_Unfocused;
                entry_Username.Unfocused += Entry_Email_Unfocused;

                lbl_Header.FontFamily = Device.OnPlatform("Orpheus Pro", "OrpheusPro.otf#OrpheusPro", "");
        ...
        {
            confirmPasswordBorder.Color = Color.White;
            emailBorder.Color = Color.White;
            passwordBorder.Color = Color.White;
            usernameBorder.Color = Color.White;
        }

        private void Entry_Username_Focused(object sender, FocusEventArgs e)
        {
            ClearBorderColors();
            usernameBorder.Color = Color.FromHex("#E0665E");
        }

        private void Entry_PasswordRepeat_Focused(object sender, FocusEventArgs e)
        {
            ClearBorderColors();
            confirmPasswordBorder.Color = Color.FromHex("#E0665E");
        }

        private void Entry_Password_Focused(object sender, FocusEventArgs e)
        {
            ClearBorderColors();
            passwordBorder.Color = Color.FromHex("#E0665E");
        }

        private void Entry_Email_Focused(object sender, FocusEventArgs e)
        {
            ClearBorderColors();
            emailBorder.Color = Color.FromHex("#E0665E");
        }
                ...
                if (App.Token != null)
                {
                    ...
                    if (response.Success)
                    {
                        ...
                        if (success)
                        {
                            ...
                            {
                                userRepo = new UserRepository(token, new RestServiceProvider(token), true, DependencyService.Get<IPlatformSpecific>().ConnectionString());
                                exhibitionRepository = new ExhibitionRepository(token, new RestServiceProvider(token), true, DependencyService.Get<IPlatformSpecific>().ConnectionString());
                                ...
                                var addedCollection = exhibitionRepository.AddDefaultCollection();
        ...
        protected async override void OnSizeAllocated(double width, double height)
        {
            ...
            try
            {
                ...
                //if(Device.OS == TargetPlatform.Android)
                //{
                //scrollView_Main.HeightRequest = 200;
                //}

                //main.HeightRequest = 200;
                ...
                //    grid_MainText.RowDefinitions.ElementAt(1).Height = rowHeight + 40;
                //    grid_MainText.RowDefinitions.ElementAt(2).Height = rowHeight + 40;
                //}
                //else
                //{
                //    grid_MainText.RowDefinitions.ElementAt(1).Height = rowHeight + 20;
                //    grid_MainText.RowDefinitions.ElementAt(2).Height = rowHeight + 20;
                ...
                //stack_SocialHolder.WidthRequest = (width / 2);


                ////////////////////////////////////////////////////////////////////////////stack_Forms.WidthRequest = (width / 2) - 30;
                stack_Forms.WidthRequest = width;

                //grid_CenterHolder.WidthRequest = 60;

                //var requestedWidth = (width / 2) - 180;
                var requestedWidth = 280;

                //btnHolder.WidthRequest = requestedWidth;

                entry_Email.WidthRequest = requestedWidth;
                entry_Password.WidthRequest = (requestedWidth / 2) - 10;
                entry_PasswordRepeat.WidthRequest = (requestedWidth / 2) - 10;
                entry_Username.WidthRequest = requestedWidth;

                emailBorder.WidthRequest = requestedWidth;
                usernameBorder.WidthRequest = requestedWidth;

                passwordBorder.WidthRequest = (requestedWidth / 2) - 10;
                confirmPasswordBorder.WidthRequest = (requestedWidth / 2) - 10;

                stackCB.WidthRequest = requestedWidth;
                stackCB2.WidthRequest = requestedWidth;
                stackCB3.WidthRequest = requestedWidth;
                btn_Facebook.WidthRequest = 330; 
                ...
                titleDescription.WidthRequest = 150;

                //Grid.SetColumn(titleDescription, 1);
                //Grid.SetRow(titleDescription, 1);

                double contentHeight = height - icons.Height;

                main.HeightRequest = height;

                //cv_Title.HeightRequest = (height * 0.1);
                //stack_Overlay.HeightRequest = (height * 0.8);
        ...
        private void BuildPopUp()
        {
            ...
            FrameCustom overlayFrame = new FrameCustom() { OutlineColor = Color.FromHex("#FFFFFF"), BackgroundColor = Color.FromHex("#1d1d1d") };
            ...
            Label lbl_Header = new Label() { FontAttributes = FontAttributes.Bold, FontSize = headerFontSize, TextColor = textColor, FontFamily = Device.OnPlatform("Orpheus Pro", "OrpheusPro.otf#OrpheusPro", "") };
            ...
            tgr_ClosePopUp.Tapped += (s, e) =>
            {
                Task.Factory.StartNew(async () =>
                {
                    ...
                    stack_Background.IsVisible = false;
                }
                );
            };
        ...
        private void BuildHelpPopUp()
        {
            ...
            var textFont = Device.OnPlatform("Freight", "freightsans.otf#Freight", "");
            var headerFont = Device.OnPlatform("Orpheus Pro", "OrpheusPro.otf#OrpheusPro", "");

            Label lbl_Header = new Label() { FontAttributes = FontAttributes.Bold, FontSize = headerFontSize, TextColor = textColor, FontFamily = Device.OnPlatform("Orpheus Pro", "OrpheusPro.otf#OrpheusPro", ""), Margin = new Thickness(10, 10, 0, 5) };
            lbl_Header.Text = "You've successfully created an account. How can I get started?";

            Label lbl_HelpLine1 = new Label() { FontFamily = textFont, TextColor = textColor, FontSize = firstTitle, Text = "Read our tips for how you can use this app if you're a teacher or museum curator on our Welcome screen." };
            Label lbl_HelpLine2 = new Label() { FontFamily = textFont, TextColor = textColor, FontSize = firstTitle, Text = "Browse popular collections from the Archives and our partners, search content thematically from the Tag section, or view others using the app in the Curators section." };
            Label lbl_HelpLine3 = new Label() { FontFamily = textFont, TextColor = textColor, FontSize = firstTitle, Text = "Create your own thematic collection by clicking on 'My Collections' via your profile icon and then on 'Add collection.' Once you save it, make it 'private' if it's still a work in progress." };
            Label lbl_HelpLine4 = new Label() { FontFamily = textFont, TextColor = textColor, FontSize = firstTitle, Text = "You can also use the ' + ' buttons on any item in the app to add it to your collection, or start a new collection with that item." };

            grid_MainText = new Grid()
            {
                Margin = new Thickness(10, 0, 0, 5),
                RowDefinitions = { new RowDefinition() { Height = rowHeight }, new RowDefinition() { Height = rowHeight + 20 }, new RowDefinition() { Height = rowHeight + 20 }, new RowDefinition() { Height = rowHeight + 20 }, },
