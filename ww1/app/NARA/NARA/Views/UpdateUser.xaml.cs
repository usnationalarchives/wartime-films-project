...
namespace NARA
{
    ...
    public partial class UpdateUser : ContentPage
    {
        ...
        BoxView bv_Name = new BoxView()
        {
            HorizontalOptions = LayoutOptions.FillAndExpand,
            HeightRequest = 1,
            Color = Color.FromHex("#717171")
        };
        BoxView bv_Surname = new BoxView()
        {
            HorizontalOptions = LayoutOptions.FillAndExpand,
            HeightRequest = 1,
            Color = Color.FromHex("#717171")
        ...
        public UpdateUser()
        {
            try
            {
                ...
                btnHolder.Children.Add(bv_Name);
                btnHolder.Children.Add(entry_Surname);
                btnHolder.Children.Add(bv_Surname);
                ...
                entry_Name.Focused += Entry_Name_Focused;
                entry_Surname.Focused += Entry_Surname_Focused;
                entry_Email.Focused += Entry_Email_Focused;
                entry_Email.Unfocused += Entry_Email_Unfocused;
                entry_Surname.Unfocused += Entry_Email_Unfocused;
                entry_Email.Unfocused += Entry_Email_Unfocused;
            }
            catch (Exception e)
            {
        ...
        private void Entry_Surname_Focused(object sender, FocusEventArgs e)
        {
            ClearBorders();
            bv_Surname.Color = Color.FromHex("#E0665E");
        }

        private void Entry_Name_Focused(object sender, FocusEventArgs e)
        {
            ClearBorders();
            bv_Name.Color = Color.FromHex("#E0665E");
        }
        ...
        {
            bv_Name.Color = Color.FromHex("#717171");
            bv_Surname.Color = Color.FromHex("#717171");
