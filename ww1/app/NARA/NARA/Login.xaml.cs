...
namespace NARA
{
    ...
    public partial class Login : ContentPage
    {
        ...
        Label lbl_ForgotYourPassword = new Label() { IsVisible = false, Text = "Forgot your password?", TextColor = Color.FromHex("#E0665E"), HorizontalOptions = LayoutOptions.EndAndExpand, VerticalOptions = LayoutOptions.CenterAndExpand };
        ...
        public Login(string returnUrl = "", string message = "")
        {
            try
            {
                ...
                btn_SignUp.BackgroundColor = Color.Transparent;

                if (Device.OS == TargetPlatform.Android)
                {
                    var row = grid_SignUp.RowDefinitions.FirstOrDefault();
                    row.Height = 28;
                    btn_SignUp.FontSize = 16;
                }

                btn_SignUp.Clicked += async (s, e) =>
                {
                ...
                entry_Password = new EntryCustom() { Placeholder = "Password             ", TextColor = Color.FromHex("#717171"), IsPassword = true, FontSize = 16, PlaceholderColor = Color.FromHex("#717171"), VerticalOptions = LayoutOptions.Center, BackgroundColor = Color.Transparent, HeightRequest = 50, HorizontalOptions = LayoutOptions.Center };
                btn_Login = new ButtonCustom() { Text = "LOG IN", WidthRequest = 160, BorderColor = Color.FromHex("#E0665E"), FontSize = 25, BorderRadius = 20, BorderWidth = 2, BackgroundColor = Color.FromHex("#E0665E"), TextColor = Color.White, VerticalOptions = LayoutOptions.Center, HorizontalOptions = LayoutOptions.Center };
            ...
            {
                //In case of an error, crach flag is set
                crash = true;
            }
        }
        ...
        async void btn_Login_Clicked(object sender, EventArgs e)
        {
            try
            {
                ...
                if (DependencyService.Get<IPlatformSpecific>().CheckConnection())
                {
                    ...
                    {
                        //In case of an error, the error message is displayed
                        lbl_Confirmation.Text = "Login failed, please check your credentials and try again";
